...
class Test(unittest.TestCase):
    def test_parse(self):
        ...
        self.assertEqual(3, e("((a: int, b: int) => a + b) 1 2;").val)
        self.assertEqual(2, e("((a: int, b: int) => a + b) 1 1;").val)
        self.assertEqual(1, e("((a: int, b: int) => a) 1 2;").val)
        self.assertEqual(-1, e("0 + -1;").val)
        self.assertEqual(0, e("((a: int) => a + 1) -1;").val)
        self.assertEqual(9, e("((a: int) => a + 10) 1 - 2;").val)
